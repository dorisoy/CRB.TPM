...
public static class ServiceCollectionExtensions
{
    ...
    {
        //加载通用配置
        var commonOptions = configuration.Get<CommonOptions>("CRB.TPM:Common");
    ...
    private static void AddApplicationServices(this IServiceCollection services, ModuleDescriptor module)
    {
        ...
        var implementationTypes = assembly.GetTypes().Where(m => m.Name.EndsWith("Service") && m.Name!= "BaseService" && !m.IsInterface).ToList();
