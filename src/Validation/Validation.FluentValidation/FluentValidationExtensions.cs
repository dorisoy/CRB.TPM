...
using CRB.TPM.Validation.FluentValidation.Validators;
...
public static class FluentValidationExtensions
{
    ...
    {
        return ruleBuilder.SetValidator(new PhoneValidator<T, string>());
    }
    ...
    {
        return ruleBuilder.SetValidator(new IPValidator<T, string>());
    }
