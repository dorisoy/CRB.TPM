...
namespace CRB.TPM.Data.Abstractions.Queryable;
...
public interface IQueryable
{
    ...
    /// <param name="paging">分页对象</param>
    /// <returns></returns>
    Task<IList<ExpandoObject>> ToPaginationExpandoObject(Paging paging);
    ...
    /// <returns></returns>
    Task<PagingQueryResultBody<dynamic>> ToPaginationDynamicResult(Paging paging);

    Task<PagingQueryResultModel<TResult>> ToPaginationResultVo<TResult>(Paging paging);
