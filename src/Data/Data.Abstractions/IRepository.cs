...
public interface IRepository
{
    ...
    /// <returns></returns>
    IEnumerable<ExpandoObject> QueryExpando(string sql, object param = null, IUnitOfWork uow = null, CommandType? commandType = null);
    ...
    /// <returns></returns>
    string GetShardingTableName(DateTime date, IEntity entity = null);
}
