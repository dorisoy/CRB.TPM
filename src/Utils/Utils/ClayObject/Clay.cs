...
namespace CRB.TPM.Utils.ClayObject;
...
public class Clay : DynamicObject
{
    ...
    /// <returns></returns>
    public static string Serialize(object value, object jsonSerializerOptions = null)
    {
    ...
    /// <param name="jsonSerializerOptions"></param>
    /// <returns></returns>
    public static T Deserialize<T>(string json, object jsonSerializerOptions = null)
    {
