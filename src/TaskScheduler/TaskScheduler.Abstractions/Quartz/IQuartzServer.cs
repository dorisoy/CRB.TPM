...
public interface IQuartzServer
{
    ...
    /// <returns></returns>
    Task Init(CancellationToken cancellation = default);
    ...
    /// <param name="cancellation"></param>
    /// <returns></returns>
    Task<DateTimeOffset> AddJob(IJobDetail jobDetail, ITrigger trigger, CancellationToken cancellation = default);
