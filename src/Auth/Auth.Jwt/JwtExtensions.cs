...
public static class JwtExtensions
{
    ...
    /// <returns></returns>
    public static CRBTPMAuthBuilder UseJwt(this CRBTPMAuthBuilder builder, Action<JwtBearerOptions> configure = null)
    {
        var services = builder.Services;

        //添加Jwt配置项
        var jwtOptions = builder.Configuration.Get<JwtOptions>("CRB.TPM:Auth:Jwt");
