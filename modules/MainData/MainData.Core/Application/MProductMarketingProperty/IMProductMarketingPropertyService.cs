...
namespace CRB.TPM.Mod.MainData.Core.Application.MProductMarketingProperty
{
    ...
    /// 营销产品属性服务
    /// </summary>
    public interface IMProductMarketingPropertyService
    {
        /// <summary>
        /// 查询
        /// </summary>
       ...
       Task<PagingQueryResultModel<MProductMarketingPropertyEntity>> Query(MProductMarketingPropertyQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(MProductMarketingPropertyAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(MProductMarketingPropertyUpdateDto dto);
