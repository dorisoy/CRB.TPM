...
namespace CRB.TPM.Mod.MainData.Core.Application.MTerminalDistributor
{
    ...
    /// 终端与经销商的关系信息服务
    /// </summary>
    public interface IMTerminalDistributorService
    {
        /// <summary>
        /// 查询
        /// </summary>
        ...
        /// <returns></returns>
       Task<PagingQueryResultModel<MTerminalDistributorQueryVo>> Query(MTerminalDistributorQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(MTerminalDistributorAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(MTerminalDistributorUpdateDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel<ExcelModel>> Export(MTerminalDistributorQueryDto dto);
    }
}
