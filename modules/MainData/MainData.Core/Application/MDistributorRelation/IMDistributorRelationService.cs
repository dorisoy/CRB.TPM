...
namespace CRB.TPM.Mod.MainData.Core.Application.MDistributorRelation
{
    ...
    /// 经销商分销商关系表服务
    /// </summary>
    public interface IMDistributorRelationService
    {
        /// <summary>
        /// 查询
        /// </summary>
        ...
        /// <returns></returns>
       Task<PagingQueryResultModel<MDistributorRelationQueryVo>> Query(MDistributorRelationQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(MDistributorRelationAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(MDistributorRelationUpdateDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel<ExcelModel>> Export(MDistributorRelationQueryDto dto);
