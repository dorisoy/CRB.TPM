...
namespace CRB.TPM.Mod.MainData.Core.Application.MdHeightConf
{
    public class MdHeightConfService : IMdHeightConfService
    {
        private readonly IMapper _mapper;
        private readonly IMdHeightConfRepository _repository;
        public MdHeightConfService(IMapper mapper, IMdHeightConfRepository repository)
        {
            _mapper = mapper;
        ...
        {
            var entity = _mapper.Map<MdHeightConfEntity>(dto);
        ...
        public async Task<IResultModel> Edit(Guid id)
        {
            ...
            var dto = _mapper.Map<MdHeightConfUpdateDto>(entity);
