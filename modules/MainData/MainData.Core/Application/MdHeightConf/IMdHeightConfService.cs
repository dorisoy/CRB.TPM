...
{
    /// <summary>
    /// 制高点配置 M_HeightConf服务
    /// </summary>
    public interface IMdHeightConfService
    {
        /// <summary>
        /// 查询
        /// </summary>
       ...
       Task<PagingQueryResultModel<MdHeightConfEntity>> Query(MdHeightConfQueryDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Add(MdHeightConfAddDto dto);
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        Task<IResultModel> Update(MdHeightConfUpdateDto dto);
