...
{
    public class MAdvertiserAddressService : IMAdvertiserAddressService
    {
        private readonly IMapper _mapper;
        private readonly IMAdvertiserAddressRepository _repository;
        public MAdvertiserAddressService(IMapper mapper, IMAdvertiserAddressRepository repository)
        {
            _mapper = mapper;
        ...
        {
            var entity = _mapper.Map<MAdvertiserAddressEntity>(dto);
        ...
        public async Task<IResultModel> Edit(Guid id)
        {
            ...
            var dto = _mapper.Map<MAdvertiserAddressUpdateDto>(entity);
