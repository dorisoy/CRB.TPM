...
using CRB.TPM.Mod.Admin.Core.Application.Menu;
...
[OpenApiTag("Menu", AddToDocument = true, Description = "菜单管理")]
public class MenuController : Web.ModuleController
{
    ...
    /// <returns></returns>
    [HttpGet]
    public Task<IResultModel> Tree([BindRequired] Guid groupId)
    {
