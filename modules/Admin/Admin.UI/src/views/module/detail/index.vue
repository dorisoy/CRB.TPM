<template>
  <m-dialog :title="$t('mod.admin.module_details')" custom-class="m-admin-module-detail" icon="component" width="80%"
    height="70%" no-padding no-scrollbar>
    <el-tabs tab-position="left" class="m-fill-h" type="border-card">
      <el-tab-pane>
        ...
        <el-table :data="pages" border style="width: 100%" height="100%">
          <el-table-column type="expand">
            <template #default="props">
              ...
              <el-table :data="tableData" border size="mini">
                <el-table-column :label="$t('tpm.name')" prop="text" width="150" align="center"> </el-table-column>
                <el-table-column :label="$t('tpm.code')" prop="code" width="300" align="center"> </el-table-column>
          ...
          <el-table-column :label="$t('tpm.title')" prop="title">
            <template #default="{ row }">
              {{ $t('tpm.routes.' + row.name) }}
            </template>
          </el-table-column>
          <el-table-column :label="$t('tpm.icon')" prop="icon">
            <template #default="{ row }">
      ...
      <el-tab-pane>
        ...
        <el-table :data="permissions" border style="width: 100%" height="100%">
          ...
          <el-table-column :label="$t('tpm.operate')" prop="action"> </el-table-column>
