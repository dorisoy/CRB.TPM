<template>
  <m-form-dialog :model="model" :rules="rules" v-bind="bind" v-on="on">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('mod.admin.page_route')" prop="routeName">
          <el-select v-model="model.routeName" @change="handleRouteChange">
            <el-option v-for="page in state.pages" :key="page.name" :value="page.name"
              :label="`${$t(`tpm.routes.${page.name}`)}(${page.name})`"></el-option>
          </el-select>
        </el-form-item>
      </el-col>
    </el-row>
      ...
      <el-col :span="24">
        <el-form-item :label="$t('mod.admin.menu_name')" prop="name">
          <el-table :data="localesTable" border style="width: 100%" size="small">
            <el-table-column :label="$t('mod.admin.language')" prop="lang" align="center" width="180">
            </el-table-column>
            <el-table-column :label="$t('tpm.name')" align="center">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tpm.is_show')" prop="show">
          <el-switch v-model="model.show"></el-switch>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tpm.serial_number')" prop="sort">
    ...
    <el-row>
      <el-col :span="24">
        <el-form-item :label="$t('tpm.remarks')" prop="remarks">
    ...
    const handleRouteChange = routeName => {
      ...
      if (page) {
        ...
        for (let key in model.locales) {
          model.locales[key] = cit.$i18n.messages[key].tpm.routes[page.name]
        }
      }
    }
