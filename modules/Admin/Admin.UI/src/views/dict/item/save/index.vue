<template>
  <m-form-dialog :model="model" :rules="rules" v-bind="bind" v-on="on">
    ...
    <el-form-item :label="$t('tpm.value')" prop="value">
      <el-input v-model="model.value" clearable />
    </el-form-item>
    <el-form-item :label="$t('tpm.icon')" prop="icon">
    ...
    <el-form-item :label="$t('tpm.sort')" prop="sort">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const api = tpm.api.admin.dictItem
