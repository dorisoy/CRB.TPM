...
namespace Data.Adapter.MySql.Test
{
    public class RepositoryTest : BaseTest
    {
        ...
        public async void AddTest()
        {
            ...
            //Assert.Equal("Dorisoy", article1.Creator);
        }


        [Fact]
        public async void RandomAddTest()
        {
            await ClearTable();

            var ids = new List<int>();

            Parallel.ForEach(new int[5],async s =>
            {
                var article = new ArticleEntity
                {
                    Title = "test",
                ...
                _output.WriteLine($"添加了文章 --> {article.Id}");
        ...
        public async void UpdateTest()
        {
            ...
            Assert.Equal("Dorisoy", article1.Modifier);
